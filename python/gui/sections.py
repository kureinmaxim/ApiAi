...
def create_footer(parent_window):
    ...
    dev_label.setStyleSheet("color: #6c7086; font-size: 10pt;")
    ...
    date_label.setStyleSheet("color: #6c7086; font-size: 10pt;")
    ...
    parent_window.size_label.setStyleSheet("color: #6c7086; font-size: 10pt;")

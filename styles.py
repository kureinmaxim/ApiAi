...
def apply_theme(app_or_window, theme_name="dark"):
    """Применяет тему к приложению или окну"""
    if theme_name == "light":
        app_or_window.setStyleSheet(LIGHT_THEME)
    else:
        app_or_window.setStyleSheet(DARK_THEME)
